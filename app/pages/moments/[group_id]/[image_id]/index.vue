<template>
	<splitpanes :horizontal="isMobile" class="w-full h-full" @resize="savePaneSize">
		<pane :size="paneLeft" class="pl-3 -mt-4 border-l md:pr-3" min-size="50" max-size="60">
		...
		<pane :size="paneRight" class="pl-3 overflow-hidden border-l mb-36 md:mb-auto" >
			<div class="md:h-[82.5vh] overflow-scroll">
				...
				<p class="p-4 mb-2 bg-gray-100 rounded-md">Leave a message</p>
			</div>
		</pane>
	</splitpanes>
</template>
...
<style>
	.splitpanes--vertical > .splitpanes__splitter {
		@apply w-1 rounded-full bg-gray-200 hover:bg-gray-300;
	}
