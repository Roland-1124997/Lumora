<template>
	<EHtml>
		<EHead>
			<EStyle> body { margin: 0 !important; padding: 0 !important; -webkit-font-smoothing:antialiased; } </EStyle>
		</EHead>
		<EBody>
			<EPreview> Welcome to Lumora! Please verify your email by entering the following code in the verification form: </EPreview>
					...
					<tr>
						<td align="left">
							<table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%; border-collapse: collapse">
								<tbody>
									<tr>
										<td style="background: #ffffff; padding: 28px; font-family: Arial, Helvetica, sans-serif">
											<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse">
												<tbody>
													<tr>
																...
																<tbody>
																	<tr>
																		...
																		<td style="vertical-align: middle">
																			...
																			<div style="font-size: 12px; color: #6b7280; margin-top: 2px">Security center</div>
																		</td>
																	</tr>
																</tbody>
															</table>
													...
													<tr>
														<td style="border-top: 1px solid #e6edf3; padding-top: 18px">
															<h1 style="margin: 6px 0 12px 0; color: #0f172a; font-size: 32px; font-weight: 700; line-height: 1.1">Verify your email address</h1>
															<p style="margin: 0 0 16px 0; color: #374151; font-size: 14px; line-height: 1.6">Thank you for registering! Please verify your email by entering the following code in the verification form:</p>
