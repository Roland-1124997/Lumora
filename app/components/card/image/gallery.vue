<template>
	<div>
		...
		<div :class="pane <= 38.5 ? 'grid-cols-2' : 'grid-cols-3'" class="grid gap-2 mt-4">
			<div v-for="item in content" :key="item.post_data.id" class="flex-shrink-0 w-full h-full overflow-hidden bg-gray-200 border rounded-md gallery aspect-square snap-start">
